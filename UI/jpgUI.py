...
# self implementation generated from reading ui file 'jpgUI.ui'
#
...
"background-color: rgb(170, 0, 0);")
    ...
    def retranslateUi(self):
        ...
        item.setText(_translate("self", "操作"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("self", "状态"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("self", "12"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("self", "移除"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("self", "1"))
        self.tableWidget.setSortingEnabled(__sortingEnabled)
        self.groupBox.setTitle(_translate("self", "操作"))
        self.pushButton.setText(_translate("self", "错误机器扫描"))
